...
<template>
  <aside
    class="absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden duration-300 ease-linear lg:static lg:translate-x-0 bg-gradient-to-b from-olive-900 to-olive-800"
    :class="{
    ...
    <div class="flex items-center logo-wrapper gap-2 px-6 pt-3">
      ...
      <span class="text-lg font-semibold text-white">Wandabook Admin</span>

      <button class="block lg:hidden" @click="sidebarStore.isSidebarOpen = !sidebarStore.isSidebarOpen">
